...
```
    ...
    ##            <dbl> <lgl>             <chr>              <fct>            
    ##  1       -0.134  FALSE             A                  Level1           
    ##  2        1.22   TRUE              B                  Level2           
    ##  3        0.0542 TRUE              C                  Level3           
    ##  4       -2.37   FALSE             D                  Level1           
    ##  5       -0.274  FALSE             E                  Level2           
    ##  6       -1.72   FALSE             F                  Level3           
    ##  7       -0.398  FALSE             G                  Level1           
    ##  8       -0.0432 FALSE             H                  Level2           
    ##  9        0.307  TRUE              I                  Level3           
    ## 10       -0.584  FALSE             J                  Level1
