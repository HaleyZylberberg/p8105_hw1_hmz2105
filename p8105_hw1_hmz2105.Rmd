...
This code is trying to convert these character variables into numeric variables. However, the logical and character vectors cannot be converted to numeric, and the factor numeric is meaningless as it converts each level to a number. Therefore the means cannot be calculated.